...
/**
 * Class CompilerRegistrarTrait.
 */
trait CompilerRegistrarTrait
{
...
#     * handler(s) based on the filter mode set for the chain. These modes are defined in {@see CompilerRegistrarInterface}
...
#     * @param mixed ...$by
#     *
#     * @throws RuntimeException If the mode {@see CompilerRegistrarInterface::FILTER_MODE_SINGLE} is set and the filtered
...
#            case CompilerRegistrarInterface::FILTER_MODE_FIRST:
##
#                return $this->getHandlerByModeFirst($filteredHandlerCollection);
##
#            case CompilerRegistrarInterface::FILTER_MODE_LAST:
##
#                return $this->getHandlerByModeLast($filteredHandlerCollection);
##
#            case CompilerRegistrarInterface::FILTER_MODE_SINGLE:
#            default:
##
...
##
#    /**
#     * Helper function for {@see getHandlerByMode} for mode {@see CompilerRegistrarInterface::FILTER_MODE_FIRST}.
#     *
#     * @param array $filteredHandlerCollection
#     *
...
##
#    /**
#     * Helper function for {@see getHandlerByMode} for mode {@see CompilerRegistrarInterface::FILTER_MODE_LAST}.
#     *
#     * @param array $filteredHandlerCollection
#     *
#     * @return CompilerPassHandlerInterface
...
##
#    /**
#     * Helper function for {@see getHandlerByMode} for mode {@see CompilerRegistrarInterface::FILTER_MODE_SINGLE}.
#     *
#     * @param array $filteredHandlerCollection
#     *
...
#    {
#        static $priorityInternal = CompilerRegistrarInterface::PRIORITY_INTERNAL_START;
##
#        if (null === $priority) {
